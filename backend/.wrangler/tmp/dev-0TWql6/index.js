...
function getAdmin(env2) {
  ...
  return {
    ...
    auth: /* @__PURE__ */ __name(() => ({
      ...
      updateUser: /* @__PURE__ */ __name(async (uid, data) => {
        const token = await getAccessToken(env2);
...
// .wrangler/tmp/bundle-CXEPgD/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-CXEPgD/middleware-loader.entry.ts
