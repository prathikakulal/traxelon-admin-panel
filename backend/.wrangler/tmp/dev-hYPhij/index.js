...
// .wrangler/tmp/bundle-s5uvY2/strip-cf-connecting-ip-header.js
...
function getAdmin(env2) {
  ...
  const mapValue = /* @__PURE__ */ __name((v) => {
    if (!v)
      return null;
    if (v.stringValue !== void 0)
      return v.stringValue;
    if (v.integerValue !== void 0)
      return parseInt(v.integerValue, 10);
    if (v.doubleValue !== void 0)
      return parseFloat(v.doubleValue);
    if (v.booleanValue !== void 0)
      return v.booleanValue;
    if (v.timestampValue !== void 0)
      return v.timestampValue;
    if (v.nullValue !== void 0)
      return null;
...
app.use("/api/admin/*", async (c, next) => {
  if (c.req.path === "/api/admin/status")
    return await next();
...
// .wrangler/tmp/bundle-s5uvY2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-s5uvY2/middleware-loader.entry.ts
