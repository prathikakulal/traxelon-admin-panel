...
// import { Ticket, Plus, Trash2, RefreshCw, Copy, CheckCircle2, AlertCircle } from 'lucide-react'
...
//     e.preventDefault()
//     if (Number(form.credits) < 15) { showToast('Minimum credits is 15', false); return }
...
//               <button
//                 type="button"
//                 onClick={() => setPreview(randomPreview(form.prefix, form.middleName, form.suffix))}
...
//             </div>
//             <div>
//               <div style={{ fontSize: 10, color: P.muted, fontFamily: "'JetBrains Mono',monospace", letterSpacing: 1, marginBottom: 6, textTransform: 'uppercase' }}>Credits (min 15)</div>
//               <input type="number" name="credits" value={form.credits} onChange={handleChange} min={15} required
...
//           </div>
//           <button className="abtn abtn-g" style={{ padding: '5px 12px', fontSize: 11 }} onClick={fetchVouchers}>
...
// ── Demo vouchers to show team lead ──────────────────────────────────────────
const DEMO_VOUCHERS = [
  {
    id: '1', code: 'TRX-LAUNCH-K7R9QM-2026',
    prefix: 'TRX', middleName: 'LAUNCH', suffix: '2026',
    credits: 25, startDate: '2026-04-01', endDate: '2026-04-30',
    redeemed: false, redeemedBy: null, createdAt: '2026-04-01T10:00:00Z',
  },
  {
    id: '2', code: 'TRX-TEAM-BX42WN-2026',
    prefix: 'TRX', middleName: 'TEAM', suffix: '2026',
    credits: 50, startDate: '2026-04-01', endDate: '2026-05-31',
    redeemed: true, redeemedBy: 'officer_uid_abc123', createdAt: '2026-04-02T09:00:00Z',
  },
  {
    id: '3', code: 'TRX-DEMO-P9LZMQ-2026',
    prefix: 'TRX', middleName: 'DEMO', suffix: '2026',
    credits: 15, startDate: '2026-04-20', endDate: '2026-04-25',
    redeemed: false, redeemedBy: null, createdAt: '2026-04-20T08:00:00Z',
  },
]
...
export default function VouchersView({ showToast }) {
  ...
  const handleCreate = (e) => {
    ...
    setSubmitting(true)
    setTimeout(() => {
      const code = randomPreview(form.prefix, form.middleName, form.suffix)
      const newVoucher = {
            ...
            <tbody>
              {vouchers.map(v => (
                <tr key={v.id} className="atr" style={{ borderBottom: `1px solid ${P.border}18` }}>
                  ...
                  {/* ── DELETE button now always visible for all vouchers ── */}
                  <td style={{ padding: '12px 14px' }}>
                    <button className="aib" style={{ color: P.red }} onClick={() => handleDelete(v)}>
                      <Trash2 size={12} />
                    </button>
